...
<body>
	...
	<!-- 
		file input box에 선택한 파일 제한하기
		accept=".hwp" 확장자가 hwp인 파일만 선택
		accept=".jpg", accept=".png", accept=".gif" : 이미지 파일중에서 jgp, png, gif 만
		
		accept="image/*": 모든 이미지 파일
		accept="video/*": 모든 비디오파일
		accept="audio/*": 모든 음성파일
		accept="image/*, video/*, audio/*" 이것들만 받기
	 -->
</body>
</html>