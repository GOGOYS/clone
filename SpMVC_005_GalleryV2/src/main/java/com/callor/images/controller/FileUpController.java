...
public class FileUpController {
	 ...
	 */
	@RequestMapping(value="/filesups", method=RequestMethod.GET)
	public String upFiles(@ModelAttribute("bbsVO")BBsVO bbsVO,  Model model) {
		
		return null;
	}
	
	@RequestMapping(value="/filesups", method=RequestMethod.POST)
	public String upFiles(@ModelAttribute("bbsVO") BBsVO bbsVO,
			MultipartHttpServletRequest mFiles, Model model) {
