...
public class bbsConrtoller {
	 ...
	 * Spring아 내가 지금 BBsVO type의 bbsVO객체 값이 필요하니
	 * 나에게 주입 해달라 요청
	 * 
	 * spring은 어딘가에 있는 @ModelAttribute("bbsVO")가 설정된
	 * method를 찾아서 실행하여 return 값을 준다.
	 */
	...
	public String write(@ModelAttribute("bbsVO") BBsVO bbsVO, Model model) {
		...
		/*
		 * 주입받은 bbsVO 객체를 form(.JSP)로 전달하기
		 */
